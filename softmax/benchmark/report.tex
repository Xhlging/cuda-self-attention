...
% ---- CJK-friendly listings setup ----
% In xelatex, code comments containing Chinese must render in a CJK-capable font.
% The fix: use \setCJKmonofont (requires a CJK mono font installed).
% If the font below is missing, install it or change to one you have:
%   Linux:   sudo apt install fonts-noto-cjk
%   macOS:   brew install font-noto-sans-cjk-sc
%   Windows: included with TeX Live 2021+
% If you don't want CJK mono, remove the Chinese comments from the code blocks.
\IfFontExistsTF{Noto Sans Mono CJK SC}{
  \setCJKmonofont{Noto Sans Mono CJK SC}[Scale=MatchLowercase]
}{
  \setCJKmonofont{Noto Sans CJK SC}[Scale=MatchLowercase]
}
